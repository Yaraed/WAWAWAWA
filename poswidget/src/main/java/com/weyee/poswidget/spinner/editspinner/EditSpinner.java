...
import com.weyee.poswidget.util.ResUtils;
import com.weyee.poswidget.util.ThemeUtils;
...
public class EditSpinner extends FrameLayout implements View.OnClickListener, AdapterView.OnItemClickListener, TextWatcher {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.spinner_edit_layout, this);
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (tArray != null) {
            ...
            setTextSize(tArray.getDimensionPixelSize(R.styleable.EditSpinner_es_textSize, ThemeUtils.resolveDimension(getContext(), R.attr.config_size_spinner_text)));
    ...
    private void initPopupWindow() {
        ...
        mPopupWindow.setListSelector(ResUtils.getDrawable(getContext(), R.drawable.config_list_item_selector));
    ...
    public EditSpinner setEditTextHeight(int dp) {
        if (mEditText != null) {
            mEditText.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, SizeUtils.dp2px(dp)));
        }
        return this;
    }
    ...
    public EditSpinner setEditTextWidth(int dp) {
        ...
        params.width = SizeUtils.dp2px(dp);
