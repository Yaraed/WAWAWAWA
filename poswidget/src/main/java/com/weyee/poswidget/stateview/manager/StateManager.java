...
public class StateManager implements StateViewManager, StateLoader, StateChanger {
    ...
    public View setContentView(int layoutId) {
        ...
        //注册核心view的State
        addState(new ContentState(view));
        showState(ContentState.STATE);
    ...
    public View getContentView() {
        return getStateView(ContentState.STATE);
    }
    ...
    public void setStateRepository(StateRepository stateRepository) {
        ...
        stateRepository.addState(this.stateRepository.get(ContentState.STATE));
