 ...
 *
 */
class TabHostFragment : BaseLazyFragment<BasePresenter<BaseModel, IView>>() {
    ...
    override fun initView(savedanceState: Bundle?) {
        ...
        textView.text = String.format(getString(R.string.hello_blank_fragment), arguments?.getInt("position"))
    }
