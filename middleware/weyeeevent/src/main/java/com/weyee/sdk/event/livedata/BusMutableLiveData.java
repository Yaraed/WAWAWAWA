 ...
 */
final class BusMutableLiveData<T> extends MutableLiveData<T> implements Observable<T> {
    ...
    public void postValueDelay(T value, long delay) {
        mainHandler.postDelayed(() -> setValue(value), delay);
    }
    ...
    public void removeObserver(@NonNull Observer<? super T> observer) {
        ...
        if (!hasObservers()) {
            LiveEventBus.get().getBus().remove(key);
        }
    }
