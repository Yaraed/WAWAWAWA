...
import com.weyee.sdk.api.rxutil.task.RxIOTask;
import com.weyee.sdk.api.rxutil.task.RxIteratorTask;
...
public class RxJavaUtils {
    ...
    private RxJavaUtils() {
        throw new IllegalStateException("Can't instance the RxJavaUtils");
    }
    ...
    public static <T> Disposable doInUIThread(@NonNull RxUITask<T> uiTask) {
        return doInUIThread(uiTask, new SimpleThrowableAction());
    }
    ...
    public static <T> Disposable doInIOThread(@NonNull RxIOTask<T> ioTask) {
        return doInIOThread(ioTask, new SimpleThrowableAction());
    }
    ...
    public static Disposable polling(long initialDelay, long interval, @NonNull Consumer<Long> consumer) {
        return polling(initialDelay, interval, TimeUnit.SECONDS, consumer, new SimpleThrowableAction());
    }
    ...
    public static Disposable delay(long delayTime, @NonNull Consumer<Long> consumer) {
        return delay(delayTime, TimeUnit.SECONDS, consumer, new SimpleThrowableAction());
    }
    ...
    public static <T, R> Disposable executeAsyncTask(@NonNull RxAsyncTask<T, R> rxTask) {
        return executeAsyncTask(rxTask, new SimpleThrowableAction());
    }
    ...
    public static <T, R> Disposable executeAsyncTask(@NonNull T t, @NonNull Function<T, R> func1, @NonNull Consumer<R> consumer) {
        return executeAsyncTask(t, func1).subscribe(consumer, new SimpleThrowableAction());
    }
     ...
     * @return
     */
    public static <T, R> Disposable executeAsyncTask2(@NonNull T t, @NonNull Function<T, R> func1, @NonNull DisposableObserver<R> subscriber) {
     ...
     * @return
     */
    public static <R> Disposable executeAsyncTask2(@NonNull Function<Integer, R> func1, @NonNull DisposableObserver<R> subscriber) {
    ...
    public static <T, R> Disposable executeAsyncTask(@NonNull T t, @NonNull FlowableTransformer<T, R> transformer, @NonNull Consumer<R> consumer) {
        return executeAsyncTask(t, transformer).subscribe(consumer, new SimpleThrowableAction());
    }
    ...
    public static <T, R> Disposable executeRxIteratorTask(final RxIteratorTask<T, R> rxIteratorTask) {
        return executeRxIteratorTask(rxIteratorTask, new SimpleThrowableAction());
    }
    ...
    public static <T, R> Disposable foreach(@NonNull T[] t, @NonNull Function<T, R> func1, @NonNull Consumer<R> consumer) {
        return foreach(t, func1, consumer, new SimpleThrowableAction());
    }
    ...
    public static <T, R> Disposable foreach(@NonNull T[] t, @NonNull FlowableTransformer<T, R> transformer, @NonNull Consumer<R> consumer) {
        return foreach(t, transformer, consumer, new SimpleThrowableAction());
    }
