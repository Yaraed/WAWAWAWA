 ...
 */
final class HtmlImageGetter implements ImageGetter {
    ...
    public Drawable getDrawable(String source) {
        ...
        if (imageLoader != null) {
            imageDrawable.setDrawable(ContextCompat.getDrawable(textView.getContext(), imageLoader.getDefaultDrawable()), false);
            imageLoader.loadImage(source, new HtmlImageLoader.Callback() {
                ...
                public void onLoadFailed() {
                    runOnUiThread(() -> {
                        imageDrawable.setDrawable(ContextCompat.getDrawable(textView.getContext(), imageLoader.getErrorDrawable()), false);
                        textView.setText(textView.getText());
                    });
                }
            });
